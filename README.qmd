...
3. **Agree ownership of the modelling process** in Touchstone and Risklink.
   By extension, the data format to be delivered to, and produced by, the modeller
   will be formally agreed.

4. **Produce checklists and results templates** to aid managerial review and to give
   the analyst running the process clear criteria for completion.

5. **Implement modern analytical database tooling and version control.** These must
...
![ETL Process](etl-excalidraw.png)
...
![Post-Modelling ELT Workflow](elt-rollup.png)
