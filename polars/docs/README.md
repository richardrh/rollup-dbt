...
| [`calculations.md`](calculations.md) | Every january duckdb view → polars stage mapping, with the original SQL quoted. Also: official-rollup selection logic, dbt-seed gaps, reference-data source-of-truth notes. |
