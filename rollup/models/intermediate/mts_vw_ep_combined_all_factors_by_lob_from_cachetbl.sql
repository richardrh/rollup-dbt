-- loader.main.mts_vw_ep_combined_all_factors_by_lob_from_cachetbl source

CREATE VIEW mts_vw_ep_combined_all_factors_by_lob_from_cachetbl AS WITH loss_per_year AS (
SELECT
    row_number() OVER (PARTITION BY base_model,
    rollup_lob,
    cds_cat_class_name,
    rollup_region_peril,
    metric
