-- loader.main.mts_vw_ep_combined_all_factors source

CREATE VIEW mts_vw_ep_combined_all_factors AS WITH loss_per_year AS (
SELECT
...
ORDER BY
    ...
    sum("value") AS "value"
FROM
    loader.main.mts_vw_ylt_combined_all_factors_long
GROUP BY
    cds_cat_class_name,
    base_model,
    rollup_region_peril,
