-- loader.main.mts_vw_ep_combined_all_factors_by_cds_class_from_cachetbl source

CREATE VIEW mts_vw_ep_combined_all_factors_by_cds_class_from_cachetbl AS WITH loss_per_year AS (
SELECT
