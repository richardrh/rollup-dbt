-- loader.marts.mts_vw_ylt_combined_all_factors_long__aggd_for_cds__fanout_air source

CREATE VIEW marts.mts_vw_ylt_combined_all_factors_long__aggd_for_cds__fanout_air AS
SELECT
